...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $group1 = (string) Str::uuid();
        $group2 = (string) Str::uuid();
        $group3 = (string) Str::uuid();

        $posts = [
            [
                'locale' => 'en',
                'translation_group_id' => $group1,
            ...
            [
                'locale' => 'vi',
                'translation_group_id' => $group1,
                'title' => 'Cách lập kế hoạch nhà máy trong khu công nghiệp để bàn giao nhanh hơn',
                'slug' => 'lap-ke-hoach-nha-may-khu-cong-nghiep-ban-giao-nhanh',
                'excerpt' => 'Khung làm việc thực tế để thống nhất phạm vi, tiến độ và hạ tầng tiện ích trước khi thi công.',
                'content' => '<p>Các dự án nhà máy trong KCN triển khai nhanh hơn khi thiết kế, giao diện tiện ích và trình tự thi công được lập kế hoạch cùng nhau.</p>',
                'thumbnail_path' => 'frontend/images/post-1.jpg',
                'category_slug' => 'constructor',
                'published_at' => now()->subDays(30),
            ],
