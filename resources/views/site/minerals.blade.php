            ...
            <div class="col-xl-6">
                <div class="hero-content-silver">
                    <div class="section-title">
                        <h3 class="wow fadeInUp">{{ __('site.minerals.hero.brand') }}</h3>
                        <h1 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.hero.title') }}</h1>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">{{ __('site.minerals.hero.description') }}</p>
                    </div>
                    <div class="hero-content-body-silver wow fadeInUp" data-wow-delay="0.4s">
                        <div class="hero-body-item-silver">
                            ...
                            <div class="hero-body-item-content-silver">
                                <h3>{{ __('site.minerals.hero.item1_title') }}</h3>
                            </div>
                        </div>
                        <div class="hero-body-item-silver">
                            <div class="icon-box">
                    ...
                    <div class="hero-content-footer-silver wow fadeInUp" data-wow-delay="0.6s">
                        <div class="hero-btn">
                            <a href="{{ route('site.contact') }}" class="btn-default btn-highlighted">{{ __('site.minerals.hero.cta') }}</a>
                        </div>
                        <div class="video-play-button">
                            <a href="https://www.youtube.com/watch?v=hDwNapdDdQA" class="popup-video" data-cursor-text="{{ __('site.common.play') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-play" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <polygon points="5 3 19 12 5 21 5 3"></polygon>
                                </svg>
                            </a>
                            <h3>{{ __('site.minerals.hero.video') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="about-us-image-box-silver wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="about-counter-box-silver">
                        <div class="about-counter-silver">
                            ...
                            <p>{{ __('site.minerals.about.counter_text') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-6">
                <div class="about-us-content-silver">
                    <div class="section-title">
                        <h3 class="wow fadeInUp">{{ __('site.minerals.about.title') }}</h3>
                        <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.about.headline') }}</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.2s">{{ __('site.minerals.about.description') }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row section-row">
            <div class="col-lg-12">
                <div class="section-title section-title-center">
                    <h3 class="wow fadeInUp">{{ __('site.minerals.services.title') }}</h3>
                    <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.services.subtitle') }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="what-we-do-box-silver wow fadeInUp">
                    <div class="what-we-box-header-silver">
                        <div class="what-we-header-counter-silver">
                            ...
                            <p>{{ __('site.minerals.what_we_do.counter_text') }}</p>
                        </div>
                        <div class="what-we-counter-info-silver">
                            <p>{{ __('site.minerals.what_we_do.counter_info') }}</p>
                        </div>
                    </div>
                    <div class="what-we-body-silver">
                        ...
                        <div class="what-we-counter-box-silver">
                            <div class="what-we-counter-box-title-silver">
                                <h3>{{ __('site.minerals.what_we_do.numbers_title') }}</h3>
                            </div>
                            <div class="what-we-counter-list-silver">
                                <div class="what-we-counter-item-silver">
                                    <h2><span class="counter">15</span>+</h2>
                                    <p>{{ __('site.minerals.what_we_do.stat1_label') }}</p>
                                </div>
                                <div class="what-we-counter-item-silver">
                                    <h2><span class="counter">50</span>+</h2>
                                    <p>{{ __('site.minerals.what_we_do.stat2_label') }}</p>
                                </div>
                                <div class="what-we-counter-item-silver">
                                    <h2><span class="counter">120</span>+</h2>
                                    <p>{{ __('site.minerals.what_we_do.stat3_label') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-7 order-xl-2 order-1">
                <div class="what-we-do-content-silver">
                    <div class="section-title">
                        <h3 class="wow fadeInUp">{{ __('site.minerals.what_we_do.eyebrow') }}</h3>
                        <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.what_we_do.title') }}</h2>
                    </div>
                    <div class="what-we-content-body-silver">
                        ...
                        <div class="what-we-items-btn-silver">
                            ...
                            <div class="what-we-do-btn-silver wow fadeInUp" data-wow-delay="0.6s">
                                <a href="{{ route('site.contact') }}" class="btn-default">{{ __('site.minerals.what_we_do.cta') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="award-title-box-silver">
                    <div class="section-title">
                        <h3 class="wow fadeInUp">{{ __('site.minerals.award.title') }}</h3>
                        <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.award.headline') }}</h2>
                    </div>
                    <div class="award-counter-box-silver">
                        <h2><span class="counter">18</span>+</h2>
                        <h3>{{ __('site.minerals.award.recognitions') }}</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="award-item-list-silver">
                    <div class="award-item-silver wow fadeInUp">
                        ...
                        <div class="award-item-content-silver">
                            ...
                            <ul>
                                <li>{{ __('site.minerals.award.item1_li1') }}</li>
                                <li>{{ __('site.minerals.award.item1_li2') }}</li>
                                <li>{{ __('site.minerals.award.item1_li3') }}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="award-item-silver wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="award-item-content-silver">
                            ...
                            <ul>
                                <li>{{ __('site.minerals.award.item2_li1') }}</li>
                                <li>{{ __('site.minerals.award.item2_li2') }}</li>
                                <li>{{ __('site.minerals.award.item2_li3') }}</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="award-item-silver wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="award-item-content-silver">
                            ...
                            <ul>
                                <li>{{ __('site.minerals.award.item3_li1') }}</li>
                                <li>{{ __('site.minerals.award.item3_li2') }}</li>
                                <li>{{ __('site.minerals.award.item3_li3') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="our-pricing-silver">
    <div class="container">
        <div class="row section-row">
            <div class="col-lg-12">
                <div class="section-title section-title-center">
                    <h3 class="wow fadeInUp">{{ __('site.minerals.delivery_models.title') }}</h3>
                    <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.delivery_models.subtitle') }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="pricing-item-silver wow fadeInUp">
                    ...
                    <div class="pricing-item-body-silver">
                        <div class="pricing-item-list-silver">
                            <h2>{{ __('site.minerals.delivery_models.plan1_phase') }}<sub>/{{ __('site.minerals.delivery_models.project_sub') }}</sub></h2>
                            <ul>
                                <li>{{ __('site.minerals.delivery_models.plan1_li1') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan1_li2') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan1_li3') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan1_li4') }}</li>
                            </ul>
                        </div>
                        <div class="pricing-item-btn-silver">
                            <a href="{{ route('site.contact') }}" class="btn-default">{{ __('site.minerals.delivery_models.plan_button') }}</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="pricing-item-silver wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="pricing-item-body-silver">
                        <div class="pricing-item-list-silver">
                            <h2>{{ __('site.minerals.delivery_models.plan2_phase') }}<sub>/{{ __('site.minerals.delivery_models.project_sub') }}</sub></h2>
                            <ul>
                                <li>{{ __('site.minerals.delivery_models.plan2_li1') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan2_li2') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan2_li3') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan2_li4') }}</li>
                            </ul>
                        </div>
                        <div class="pricing-item-btn-silver">
                            <a href="{{ route('site.contact') }}" class="btn-default">{{ __('site.minerals.delivery_models.plan_button') }}</a>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="pricing-item-silver wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="pricing-item-body-silver">
                        <div class="pricing-item-list-silver">
                            <h2>{{ __('site.minerals.delivery_models.plan3_phase') }}<sub>/{{ __('site.minerals.delivery_models.project_sub') }}</sub></h2>
                            <ul>
                                <li>{{ __('site.minerals.delivery_models.plan3_li1') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan3_li2') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan3_li3') }}</li>
                                <li>{{ __('site.minerals.delivery_models.plan3_li4') }}</li>
                            </ul>
                        </div>
                        <div class="pricing-item-btn-silver">
                            <a href="{{ route('site.contact') }}" class="btn-default">{{ __('site.minerals.delivery_models.plan_button') }}</a>
...
<div class="our-working-process-silver dark-section">
    <div class="container">
        <div class="row section-row">
            <div class="col-lg-12">
                <div class="section-title section-title-center">
                    <h3 class="wow fadeInUp">{{ __('site.minerals.working_process.title') }}</h3>
                    <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.working_process.subtitle') }}</h2>
                </div>
            </div>
        </div>
...
<div class="our-testimonials-silver">
    <div class="container">
        <div class="row">
            <div class="col-xl-5">
                <div class="our-testimonial-content-silver">
                    <div class="section-title">
                        <h3 class="wow fadeInUp">{{ __('site.minerals.testimonials.title') }}</h3>
                        <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.testimonials.subtitle') }}</h2>
                    </div>
                </div>
            </div>
            <div class="col-xl-7">
...
<div class="our-blog">
    <div class="container">
        <div class="row section-row">
            <div class="col-lg-12">
                <div class="section-title section-title-center">
                    <h3 class="wow fadeInUp">{{ __('site.minerals.blog.title') }}</h3>
                    <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('site.minerals.blog.subtitle') }}</h2>
                </div>
            </div>
        </div>
