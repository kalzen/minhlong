        ...
        <div class="row section-row">
            <div class="col-lg-12">
                <div class="section-title section-title-center">
                    ...
                    <h2 class="text-anime-style-3" data-cursor="-opaque">Insights for factory construction and industrial project delivery</h2>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="post-item wow fadeInUp">
                    ...
                    <div class="post-item-body">
                        ...
                        <div class="post-item-btn"><a href="#" class="readmore-btn">Read More</a></div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
