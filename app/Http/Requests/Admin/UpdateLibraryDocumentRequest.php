...
class UpdateLibraryDocumentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'file' => ['nullable', 'file', 'max:51200', 'mimetypes:text/csv,text/plain,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'],
        ];
    }
